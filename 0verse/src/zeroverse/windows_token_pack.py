...
PACK_SCHEMA_VERSION = "0.windows-token-evidence-pack/v1"
LPAC_PACK_SCHEMA_VERSION = "0.windows-token-evidence-pack/v2"
LPAC_LAUNCH_PACK_SCHEMA_VERSION = "0.windows-token-evidence-pack/v3"
ENVELOPE_SCHEMA_VERSION = "0.windows-token-evidence-pack-envelope/v1"
POLICY_SCHEMA_VERSION = "0.windows-token-evidence-acceptance-policy/v1"
LPAC_POLICY_SCHEMA_VERSION = "0.windows-token-evidence-acceptance-policy/v2"
LPAC_LAUNCH_POLICY_SCHEMA_VERSION = "0.windows-token-evidence-acceptance-policy/v3"
PACK_SIGNATURE_NAMESPACE = "0-windows-token-evidence-pack-v1"
LPAC_PACK_SIGNATURE_NAMESPACE = "0-windows-token-evidence-pack-v2"
LPAC_LAUNCH_PACK_SIGNATURE_NAMESPACE = "0-windows-token-evidence-pack-v3"
