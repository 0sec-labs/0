...
1. Connect model-authored Python artifacts to independently controlled evaluation,
   and extend remaining source/tool workflows beyond the Git/npm capture paths.
