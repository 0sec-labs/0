...
| Providers and credentials | Responses/Chat/Anthropic and native Gemini streaming adapters, bounded credentials and Entra refresh exist. Gemini tool dispatch requires final usage; signed replay/context and offline retries are locally qualified. Complete legacy provider/login/process-provider coverage and live qualification remain incomplete. See `crates/zero-provider/README.md`. |
