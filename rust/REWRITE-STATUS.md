...
| Distribution and cutover | Experimental native binary and local committed-source Linux packaging/integrity verification exist; release and development archives have passed host startup and digest checks. Production aliases/options, installers/images, supported platforms, old-state migration, operational comparisons and rollback release remain open. See `NATIVE-DISTRIBUTION.md`. See `MIGRATION.md`, `../packages/cli/src/routing.ts`. |
