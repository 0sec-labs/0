...
| Git source acquisition | Explicit Git ref capture, pinned source/receipt, bounded process supervision and CLI review handoff work. Explicit receipt binding to review admission, archived content/mode validation and offline retained provenance are implemented. Private repository authentication and package/OCI acquisition remain open. See `SOURCE-ACQUISITION.md`. |
...
1. Connect package acquisition to retained source review and model-authored Python
   artifacts to independently controlled evaluation.
