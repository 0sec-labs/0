...
0sec now has \textbf{two} ways to run more than one agent, and they are
...
all drawn from \textbf{Oh My Pi} \citep{omp}. Where 0sec diverges --- the pure,
injected park loop; the Zod-validated spawn tool; the single-chokepoint inbound
sanitiser; the authority-free addressing policy --- it is to fit 0sec's security
