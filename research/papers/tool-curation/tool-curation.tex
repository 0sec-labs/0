...
\begin{abstract}
0 registers 56 model-facing tools, and its default interactive console
...
non-console lanes of 0 (discovery, attack, verify, report, subagents) already
...
0 already ships progressive disclosure --- for methodology, not for tools. The
...
\begin{enumerate}[leftmargin=*]
  ...
  static set sized to the band. 0 already has per-role sets
