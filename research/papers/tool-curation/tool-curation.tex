...
\begin{abstract}
0sec registers 56 model-facing tools, and its default interactive console
...
non-console lanes of 0sec (discovery, attack, verify, report, subagents) already
...
\begin{itemize}[leftmargin=*]
  ...
  \item 0verse binary tools behind \texttt{zeroverse}
...
0sec already ships progressive disclosure --- for methodology, not for tools. The
...
\begin{enumerate}[leftmargin=*]
  ...
  static set sized to the band. 0sec already has per-role sets
