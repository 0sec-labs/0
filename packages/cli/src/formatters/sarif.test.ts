...
describe("formatSarif", () => {
  it("emits GitHub Code Security metadata for PoC-backed findings", () => {
    ...
    expect(result.partialFingerprints.primary).toBe("stable-fp|0:path-traversal|path-traversal|Path traversal reads secrets|pkg/file.ts");
