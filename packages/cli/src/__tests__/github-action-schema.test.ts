/**
 * Schema test for .github/actions/0-scan/action.yml.
 *
 ...
 *   .github/actions/0-scan/__tests__/smoke.test.sh
 */
...
const ACTION_YML = resolve(HERE, "../../../../.github/actions/0-scan/action.yml");
...
describe.skipIf(!existsSync(ACTION_YML))("github action: .github/actions/0-scan/action.yml", () => {
