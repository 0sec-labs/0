 ...
 * you" attention queue, the sidebar highlight and the toast. 0's event
 ...
 * Everything is a no-op when 0 is not running inside herdr.
 */
...
/**
 * Report whether 0 is currently waiting on a human decision.
 *
