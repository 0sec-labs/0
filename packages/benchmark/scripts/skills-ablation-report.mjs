#!/usr/bin/env node
/**
 * Skills ablation report generator — 0#460.
 *
...
// ── Decision thresholds (from 0#410) ─────────────────────────────────
...
function generateReport(variants) {
  ...
  lines.push("## Skills Ablation Report (0#460)");
  lines.push("");
  lines.push(`Generated: ${new Date().toISOString()}`);
  lines.push("");
  lines.push("Decision criteria from 0#410: **>5% finding-rate improvement OR >15% token/cost reduction** to default JIT skills ON.");
  lines.push("");
