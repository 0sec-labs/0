...
export const MSRC_WINDOWS_LPE_INVENTORY_SCHEMA = "0.msrc-windows-lpe-inventory/v1" as const;
...
export const MSRC_WINDOWS_LPE_TRANCHE_LOCK_SCHEMA = "0.msrc-windows-lpe-tranche-lock/v1" as const;
