...
export const WINDOWS_LPE_PAIRED_CORPUS_SCHEMA = "0.windows-lpe-paired-corpus/v2" as const;
export const WINDOWS_LPE_EVALUATOR_LABELS_SCHEMA = "0.windows-lpe-evaluator-labels/v2" as const;
