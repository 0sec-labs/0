...
describe("CyberGym direct-execution guard", () => {
  it("does not start the benchmark when bundled into the 0 CLI entrypoint", () => {
    expect(
      isCyberGymRunnerEntrypoint(
        "file:///tmp/0.js",
        "/tmp/0.js",
...
// ── CYBERGYM_API_KEY comes from the environment (0#132) ────────────────
//
...
describe("requireCyberGymApiKey (0#132)", () => {
