...
export const WINDOWS_LPE_AGENT_PROJECTION_SCHEMA = "0.windows-lpe-agent-projection/v1" as const;
export const WINDOWS_LPE_HANDLE_RESOLVER_SCHEMA = "0.windows-lpe-handle-resolver/v1" as const;
...
export async function resolveWindowsLpeOpaqueHandle(args: {
  ...
  const replayKey = createHash("sha256").update([
    "0.windows-lpe-opaque-consume/v1", authorityId, bundle.projectionSha256, bundle.resolverSha256, handle, runNonce,
  ].join("\u0000")).digest("hex");
