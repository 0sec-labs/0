#!/usr/bin/env node
/**
 * 0-llm — CLI for the offensive LLM red-team engine.
 *
 *   0-llm strategies                 list the strategy library
 *   0-llm gen <behaviorId>           print generated candidate payloads
 *   0-llm run <behaviorId> [--target mock|chat]
...
const main = async () => {
  switch (cmd) {
    ...
    default:
      console.log("usage: 0-llm <strategies|gen <behaviorId>|run <behaviorId> [--target mock|chat]>");
