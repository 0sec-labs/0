 ...
 * expected by drizzle-orm's `BetterSQLiteSession`. This lets 0 use a
 ...
 * better-sqlite3 API that 0's database.ts and drizzle's
...
export class ShimmedDatabase {
   ...
   * here, but losing them is acceptable for 0's single-process workload.
   */
   ...
   * All three variants are functionally equivalent for 0's single-writer
