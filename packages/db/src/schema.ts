...
// ── Persistent credential store (0#771, extends #687) ──
//
...
export const findings = sqliteTable(
  "findings",
  {
     ...
     * query individual verdict rows. See 0#112.
     */
     ...
     * whole; we never query individual predicates. See 0#193 /
     * 0-cloud#111.
     */
