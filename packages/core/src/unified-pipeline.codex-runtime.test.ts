 ...
 * binary on PATH — even if `ZERO_CHATGPT_ACCESS_TOKEN` or
 * `ZERO_CHATGPT_OAUTH_REFRESH_TOKEN` was set. That gate lived in
...
vi.mock("./runtime/llm-api.js", () => {
  ...
  // ZERO_CHATGPT_*_TOKEN env produces in real life. The new gate in
