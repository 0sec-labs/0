 ...
 *      local CLI runs are not spammed with `ZERO_EVENT_*` lines;
 ...
 *
 * e.g. `ZERO_EVENT_STEP_STARTED {"step":"recon","n":1}`.
 */
 ...
 * inside the FP-moat `pov_gate` layer, which is `ZERO_FEATURE_POV_GATE`-gated
