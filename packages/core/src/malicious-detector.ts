 ...
 *
 * The 2026-04-06 ceiling analysis identified that 0's npm-bench
 ...
 *
 * Why this exists: 0's audit pipeline runs `npm install --ignore-scripts`
 ...
 *
 * Why this exists: 0 historically source-audited only the ROOT package,
