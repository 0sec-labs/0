 ...
 *
 * The legacy `ZERO_RUNTIME_LENSES` blob remains a deliberately opt-in,
...
const RUNTIME_LENSES_FLAG = "ZERO_RUNTIME_LENSES_ENABLED";
/** Env var carrying the legacy ephemeral runtime JSON blob. */
const RUNTIME_LENSES_ENV = "ZERO_RUNTIME_LENSES";
...
/**
 * Read the flag-gated `ZERO_RUNTIME_LENSES` blob. This is intentionally kept
