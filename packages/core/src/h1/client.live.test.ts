...
//
// Gated behind ZERO_H1_LIVE=1 so a default `pnpm test` never reaches
// the network even when local creds are present. When you do want to
// run it:
//
//   env ZERO_H1_LIVE=1 pnpm --filter @0/core test src/h1/client.live.test.ts
//
// or:
//
//   env ZERO_H1_LIVE=1 H1_API_IDENTIFIER=… H1_API_TOKEN=… \
//     pnpm --filter @0/core test src/h1/client.live.test.ts
//
// Without ZERO_H1_LIVE=1, every assertion in this file is skipped.

import { describe, it, expect } from "vitest";
import { H1Client } from "./client.js";
import { loadH1Credentials } from "./credentials.js";

const liveEnabled = process.env["ZERO_H1_LIVE"] === "1";
