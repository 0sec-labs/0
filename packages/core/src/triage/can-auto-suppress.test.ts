...
describe("guardrail integration — evidence_gate (ZERO_FEATURE_EVIDENCE_GATE)", () => {
...
describe("guardrail integration — learned-router auto_reject (ZERO_FEATURE_LEARNED_ROUTER)", () => {
...
describe("guardrail integration — dynamic_triage Rule-3 (ZERO_FEATURE_DYNAMIC_TRIAGE)", () => {
