 ...
 * classifier landing in a follow-up PR (0#113 phase 2).
 *
 ...
 * 0#72 (2026-04-11) per-profile ablation comment; a later PR will
 * swap in a learned classifier (XGBoost or VulnBERT-style hybrid head)
 * trained on the per-layer telemetry shipped in 0#112 and the
 * triage dataset described in 0#67.
 *
 ...
 *
 * See 0#113 design doc, 0#72 ablation, 0#67 paper plan.
 */
...
/**
 * The v0 rule-based router. Encodes the four rules from the 0#113
 ...
 * router (phase 2 of 0#113) trains on the (features, decided_layers,
