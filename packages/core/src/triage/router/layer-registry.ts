...
export interface LayerRegistryEntry {
  ...
  name: string;
  /**
   * The ZERO_FEATURE_* env var that toggles this layer today. When the
...
export const LAYER_REGISTRY: readonly LayerRegistryEntry[] = [
  {
    ...
    env_flag: "ZERO_FEATURE_HOLDING_IT_WRONG",
    cost_factor: 0.0,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_EVIDENCE_GATE",
    cost_factor: 0.1,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_REACHABILITY_GATE",
    cost_factor: 0.2,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_MULTIMODAL",
    cost_factor: 0.3,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_PUBLISHABILITY_GATE",
    cost_factor: 0.3,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_CONSENSUS_VERIFY",
    cost_factor: 0.4,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_POV_GATE",
    cost_factor: 0.55,
    description:
  ...
  },
  {
    ...
    env_flag: "ZERO_FEATURE_POC_GEN_STATIC",
    cost_factor: 0.55,
    description:
 ...
 * `ZERO_FEATURE_DYNAMIC_TRIAGE` is unset, the router returns this set
