 ...
 * the dynamic triage router. Verifies that ZERO_FEATURE_DYNAMIC_TRIAGE
...
describe("Dynamic triage routing — integration with scanner dispatch site", () => {
  ...
  it("default (ZERO_FEATURE_DYNAMIC_TRIAGE unset) — decideLayers still computes a decision, but the scanner does not gate any layer", () => {
