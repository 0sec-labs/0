// ── First-class structured scanner tool wrappers (0#555) ──
//
// 0 is a shell-first agent and, by default, SUPPRESSES generic scanners
// in the `bash` tool (`scope/scanner-binaries.ts`, 0#217): when scope is
