/**
 * Engagement-gated scanner-wrapper tool definitions (0#611 — split out of the monolithic
 * agent/tools.ts registry).
 *
 * Structured sqlmap/nmap/ffuf/nuclei wrappers (0#555), exposed only
...
/**
 * Names of the engagement-gated structured scanner wrappers (0#555).
 ...
 * default (0#217). Kept as a module constant so both the role tool sets
