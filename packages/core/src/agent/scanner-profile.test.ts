...
// ── Authorized-engagement scanner profile gate (0#926) ──
//
...
describe("scannerEngagementGate — default OFF (0#217 stealth preserved)", () => {
...
describe("scannerEngagementGate — deny-by-default scope (0#926)", () => {
