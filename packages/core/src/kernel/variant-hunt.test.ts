...
beforeEach(() => {
  tmpRoot = mkdtempSync(join(tmpdir(), "0-kernel-variant-test-"));
});
...
describe("foxguardFindingToKernelVariantFinding", () => {
  it("maps dirty-frag foxguard hits into 0 findings with kernel provenance", () => {
...
describe("runKernelVariantHunt", () => {
  it("uses pre-produced SARIF and returns 0 findings", async () => {
