 ...
 * WHY THIS EXISTS
 * ---------------
 * 0 already authorizes tool calls through the name-keyed gates in
...
// ── Built-in guards: 0's existing invariants, encoded once ─────────────────
//
...
/**
 * The default built-in guard set, encoding 0's CURRENT invariants so the
