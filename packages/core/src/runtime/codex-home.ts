 ...
 * `$TMPDIR/0-audit-<uuid>` (`package-ecosystems.ts`) and then runs the
 ...
 *
 *     [projects."/private/var/folders/…/0-audit-8103b3c8/node_modules/lodash"]
 *     trust_level = "trusted"
 *
...
export function createEphemeralCodexHome(): EphemeralCodexHome | undefined {
  ...
  let dir: string;
  try {
    dir = mkdtempSync(join(tmpdir(), "0-codex-home-"));
  } catch {
    return undefined;
  }
