...
white-box at 102/104 (98.1%). The gpt-5.4 historical union was 93/95 (97.9%), without mode/configuration
partitioning; this is not a qualified black-box single-shot rate.
aggregate retention changes with GitHub's 90-day artifact window. Cybench scored
36/40 (90.0%), with retries under the reported configuration. Reported external XBOW figures were
