...
> Historical proposal tracked in [0#224](https://github.com/0sec-labs/0/issues/224). The commands and recovery behavior below describe the design.
...
- Tracking issue: [0#224](https://github.com/0sec-labs/0/issues/224)
