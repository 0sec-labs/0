...
Within 0 docs, Endor Labs and Semgrep Assistant are used as reference
points for this shape (with caveats that the exact commercial internals are
not fully open).

## 3) Hybrid Feature + Model Signals

0 docs cite VulnBERT-style hybrid thinking (handcrafted features plus
...
Suggested concise positioning for 0:

"Relative to prior open and closed systems, 0's primary contribution is
